...
USE_BUDDYINFO(APPLET_NOFORK(buddyinfo, buddyinfo, _BB_DIR_USR_BIN, _BB_SUID_NEVER, buddyinfo))
USE_ATLASINIT(APPLET(atlasinit, _BB_DIR_BIN, _BB_SUID_NEVER))
USE_ATLASSERIAL(APPLET(atlasserial, _BB_DIR_BIN, _BB_SUID_NEVER))
...
USE_SLEEP(APPLET_NOFORK(findpid, findpid, _BB_DIR_BIN, _BB_SUID_NEVER, findpid))
...
USE_HTTPPOST(APPLET(httppost, _BB_DIR_BIN, _BB_SUID_NEVER))
...
USE_SLEEP(APPLET_NOFORK(sleepkick, sleepkick, _BB_DIR_BIN, _BB_SUID_NEVER, sleepkick))
