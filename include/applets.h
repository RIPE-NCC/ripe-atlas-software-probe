...
USE_ATLASINIT(APPLET_NOFORK(atlasinit, atlasinit, _BB_DIR_BIN, _BB_SUID_NEVER, atlasinit))
...
USE_EVTDIG(APPLET_NOFORK(evtdig, evtdig, _BB_DIR_USR_BIN, _BB_SUID_NEVER, evtdig))
USE_ETHER_WAKE(APPLET_ODDNAME(ether-wake, ether_wake, _BB_DIR_USR_BIN, _BB_SUID_NEVER, ether_wake))
USE_EVTRACEROUTE(APPLET(evtraceroute, _BB_DIR_USR_SBIN, _BB_SUID_NEVER))
...
USE_OOQD(APPLET(ooqd, _BB_DIR_USR_SBIN, _BB_SUID_NEVER))
...
USE_TDIG(APPLET_NOFORK(tdig, tdig, _BB_DIR_USR_BIN, _BB_SUID_NEVER, tdig))
